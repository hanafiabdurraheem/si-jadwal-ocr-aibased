<div id="bottom-nav">
  <a href="index.php?route=beranda" class="nav-item">
    <img src="app/view/assets/img/beranda.svg" alt="Beranda" width="24"><br><small>Beranda</small>
  </a>
  <a href="index.php?route=jadwal" class="nav-item">
    <img src="app/view/assets/img/jadwal.svg" alt="Jadwal" width="24"><br><small>Jadwal</small>
  </a>
  <a href="index.php?route=tugas" class="nav-item">
    <img src="app/view/assets/img/tugas.svg" alt="Tugas" width="24"><br><small>Tugas</small>
  </a>
  <a href="index.php?route=pengingat" class="nav-item">
    <img src="app/view/assets/img/pengingat.svg" alt="Pengingat" width="24"><br><small>Pengingat</small>
  </a>
  <a href="index.php?route=pengaturan" class="nav-item">
    <img src="app/view/assets/img/pengaturan.svg" alt="Pengaturan" width="24"><br><small>Pengaturan</small>
  </a>
</div>
